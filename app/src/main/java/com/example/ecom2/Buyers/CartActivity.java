...
import com.example.ecom2.Model.Cart;
import com.example.ecom2.Prevalent.Prevalent;
import com.example.ecom2.R;
import com.example.ecom2.ViewHolder.CartViewHolder;
                                        ...
                                        if(i==1){
                                            ...
                                            cartListRef.child("Admin View")
                                                    ...
                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            if(task.isSuccessful()){
                                                                Toast.makeText(CartActivity.this,"Item Removed Successfully for admin also",Toast.LENGTH_LONG).show();
                                                                Intent intent=new Intent(CartActivity.this,HomeActivity.class);
                                                                startActivity(intent);
                                                            }
                                                        }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(shippingState.equals("shipped")){
                        ...
                        txtMsg1.setText("Congratulation,Your final Order has been shipped successfully.Soon you will receive your order at your doorstep");
