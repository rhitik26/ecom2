...
public class AdminMaintainProductsActivity extends AppCompatActivity {
    ...
    private void applyChanges() {
        ...
        if(pName.equals("")){
            Toast.makeText(AdminMaintainProductsActivity.this,"Write Down Product Name",Toast.LENGTH_LONG).show();
        }
        else if(pPrice.equals("")){
            Toast.makeText(AdminMaintainProductsActivity.this,"Write Down Product Price",Toast.LENGTH_LONG).show();
        }
        else if(pDescription.equals("")){
            Toast.makeText(AdminMaintainProductsActivity.this,"Write Down Product Description",Toast.LENGTH_LONG).show();
        }
        else{
